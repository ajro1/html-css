...
Os bits andam em grupos de 8 chamados bytes, sendo esses oito caracteres o número mínimo que representa uma informação. 

Na computação existem os chamados múltiplos do byte, eles são uma referência ao número de zeros e uns.
...
existe diferença entre mb (minúsculo) e o MB (maiúsculo). O maiúsculo é para representar armazenamento, e, o minúsculo é utilizado para representar transmissão de dados.
>bits: velocidade de transmissão
